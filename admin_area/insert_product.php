...
<div class="row"><!--Bắt đầu breadcrumb-->
	<div class="col-lg-12">
		<div class="breadcrumb">
			<li class="active">
				<i class="fa fa-bar-chart"></i>
				Bảng Điều Khiển / Thêm Sản Phẩm
			</li>
		</div>
	</div>
</div><!--Kết thúc breadcrumb-->
<div class="row">
	<div class="col-lg-3">
	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-heading"><!--Bắt đầu tiêu đề panel-->
				<h3 class="panel-title">
					<i class="fa fa-money fa-fw"> Thêm Sản Phẩm </i>
				</h3>
			</div><!--Kết thúc tiêu đề panel-->
