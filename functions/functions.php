...
$db=mysqli_connect("localhost","root","","duca");
...
function getPCats(){
    ...
    while ($row_p_cats=mysqli_fetch_array($run_p_cats)) {
        ...
        echo "<li ><a style='color: black;   font-size: 20px; margin: left !important; ' href='trimer.php?p_cat=$p_cat_id'>$p_cat_title</a></li>";
    }
}
...
function getCat(){
    ...
    while ($row_cat=mysqli_fetch_array($run_cat)) {
        ...
        echo "<li><a  style='color: black;   font-size: 20px;  text-align: left !important;	 ' href='trimer.php?cat_id=$cat_id'>$cat_title</a></li>";
    }
}
...
function getPcatPro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        if ($count==0) {
            echo "<div class='boxi'>
            <h1>Không tìm thấy sản phẩm trong danh mục này</h1>
            </div> ";
             }else{
                echo "<div class='boxi'>
                <h1>$p_cat_title</h1>
