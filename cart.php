...
<a id="pr" href="#"> Shopping Cart Tổng giá:  <?php totalPrice(); ?>$, Total Items <?php item(); ?></a>
</div>
            ...
            <div class="collapse clearfix" id="search">
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a class="active" href="cart.php"><i class="fa fa-shopping-cart"></i>Giỏ hàng</a></li>
   ...
   <div class="box">
     <form action="cart.php" method="post" enctype="multipart-form-data">
       ...
       $count=mysqli_num_rows($run_cart);
        ...
        ?>
       <p class="text-muted">Hiện tại bạn có: <?php echo $count ?> Sản phẩm trong giỏ hàng</p>
       ...
       <div class="box-footer">
         <div class="pull-left">
           <a href="index.php" class="btn btn-default">
             <i class="fa fa-chevron-left"></i>Tiếp tục đặt hàng
           </a>
         </div>
         <div class="pull-right">
           ...
           Đã xử lý để thanh toán<i class="fa fa-chevron-right"></i>
           </a>
         </div>
       </div>
     </form>
  ...
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price">199$</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;"  class="price"></i>99$</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>16</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>340</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>70</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>76</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>85</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p style="font-weight: bold; color: black;" class="price"><i class="fa fa-inr"></i>20</p>
      </div>
    </div>
  </div>
</div>
